#ifndef URQMD_DCA_MAP_MAKER_H
#define URQMD_DCA_MAP_MAKER_H
...
class UrQMDDcaMapMaker : public TreeAnalyzer
{
protected:
...
public:
	virtual const char* classname() const { return "UrQMDDcaMapMaker"; }
	~UrQMDDcaMapMaker();
