...
vector<string> energies = { /*"39.0", "27.0",*/ "19.6", "14.5", "11.5"/*, "7.7"*/ }; //{ "7.7", 		"11.5", 	"14.5", 	"19.6"};//, 		"27.0", 		"39.0" };
vector<int> colors 		= { kRed - 3, 	kBlue - 3, 	kRed + 3,	kGreen + 3, 	kMagenta + 3, 	kOrange + 3, kBlue	};
